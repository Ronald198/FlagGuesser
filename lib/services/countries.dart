class CountriesApi {
  ...
  static List<String>? getNameFromISOCode(String key) {
    Map<String, List<String>> countriesMap = {
      ...
      "AU": ["Australia"],
      "AW": ["Aruba"],
      "AX": ["\u00c5land Islands", "Aland Islands"], // \u00c5 = Å
      "AZ": ["Azerbaijan"],
      ...
      "CH": ["Switzerland"],
      "CI": ["C\u00f4te d'Ivoire", "Ivory Coast", "Cote d'Ivore"], // \u00f4 = ô
      "CK": ["Cook Islands"],
      "CL": ["Chile"],
      "CM": ["Cameroon"],
      "CN": ["China"],
      ...
      "VI": ["Virgin Islands, U.S.", "Virgin Islands US"],
      "VN": ["Vietnam"],
      "VU": ["Vanuatu"],
